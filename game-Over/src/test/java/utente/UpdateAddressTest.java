...
public class UpdateAddressTest {
    ...
    public void modificaConSuccesso() throws SQLException, ServletException, IOException, ParseException{
	       ...
	       Mockito.when(request.getParameter("via")).thenReturn(indirizzo);
	       ...
	       servlet.doPost(request, response);
	  	   ...
	  	   assertEquals("Modifica dell'indirizzo avvenuta correttamente.", argument.getValue());		
    }
