...
public class RiguardaDAO {
    ...
    public ArrayList<RiguardaBean> doRetrieveAll() throws SQLException {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                b.setIdTavolo(rs.getInt("idOrdine"));
                ab.add(b);
            }
            rs.close();
        }finally {
    ...
    public boolean doDelete(RiguardaBean utente) throws SQLException {
        String query="delete from "+ IncludeDAO.TABLE_NAME+" where idOrdine=?";
        Connection con=null;
        PreparedStatement ps=null;
