...
public class VideogiocoDAO {
    ...
    public int doUpdate(VideogiocoBean utente) throws SQLException {
        String query="???????";
        Connection con=null;
        PreparedStatement ps=null;
    ...
    public boolean doDelete(VideogiocoBean utente) throws SQLException {
        String query="delete from "+ VideogiocoBean.TABLE_NAME+" where id=?";
        Connection con=null;
        PreparedStatement ps=null;
